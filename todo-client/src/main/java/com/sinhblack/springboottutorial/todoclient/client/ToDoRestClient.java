...
import com.sinhblack.springboottutorial.todoclient.domain.ToDo;
import com.sinhblack.springboottutorial.todoclient.error.ToDoErrorHandler;
...
public class ToDoRestClient {
  ...
  public ToDo findById(String id){
    ...
    params.put("id", id);
    var res = restTemplate.getForObject(properties.getUrl() + properties.getBasePath() + "/{id}", ToDo.class, params);
  ...
  public ToDo setCompleted(String id) throws URISyntaxException{
    ...
    params.put("id", id);
    restTemplate.postForObject(properties.getUrl() + properties.getBasePath() + "/update/{id}", null, ResponseEntity.class, params);
